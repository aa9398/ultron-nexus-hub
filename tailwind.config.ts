    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          ...
          "50%": { boxShadow: "0 0 20px hsl(var(--primary) / 0.4), 0 0 30px hsl(var(--secondary) / 0.2)" },
        },
        "float": {
      ...
      backgroundImage: {
        ...
        "gradient-neon": "linear-gradient(90deg, hsl(var(--primary)) 0%, hsl(var(--secondary)) 50%, hsl(var(--primary)) 100%)",
      },
    },
  },
